...
*/
function Loop(time = Math.floor((Math.random() * 1) + 1)){
...
Decaimento Aleatório de Atributos
  */
  ...
  fome = fome - parseInt(Math.floor((Math.random() * 1) + 1));
  higiene = higiene - parseInt(Math.floor((Math.random() * 1) + 1));
  sono = sono - parseInt(Math.floor((Math.random() * 1) + 1));
  diversao = diversao - parseInt(Math.floor((Math.random() * 1) + 1));
  social = social - parseInt(Math.floor((Math.random() * 1) + 1));
